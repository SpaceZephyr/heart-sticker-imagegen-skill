...
description: 将用户上传的照片、人物或宠物图片转换成心念贴纸风格，或把指定文字生成文字贴纸。使用 mundane799699/heart-sticker 的 11 套图生图提示词和 9 套文字提示词；当用户提到图片贴纸、照片转风格、人物贴纸、宠物贴纸、文字图片、文字海报、字体图片或文字贴纸，并希望先选风格再用 Codex imagegen 生成时使用。
---
